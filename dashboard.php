    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        ...
        <div class="tile-group double">
            ...
            <div class="tile-container">
                ...
                <div class="tile-small bg-green fg-white" data-role="tile" id="ctrl_button_camera2">
                    <div class="tile-content iconic">
                        <span class="icon mif-video-camera"></span>
                    </div>
                </div>
                <div class="tile-small bg-pink fg-white" data-role="tile" id="ctrl_button41"
        ...
        <div class="tile-group double">
            <span class="tile-group-title">Master Bedroom</span>
              <div class="tile-wide" data-role="tile" data-effect="slideLeft">
                ...
                <div class="tile-small bg-pink fg-white" data-role="tile" id="ctrl_button">
                    <div class="tile-content iconic">
            ...
            <span class="tile-group-title">Bedroom 1</span>
              <div class="tile-wide" data-role="tile" data-effect="slideLeft">
               ...
               <div class="tile bg-yellow fg-white" data-role="tile" id="ctrl_button1"
                ...
                <div class="tile bg-darkOrange fg-white" data-role="tile" id="ctrl_button4"
                        onclick="check(4,'<?php echo status(4)?>')">
