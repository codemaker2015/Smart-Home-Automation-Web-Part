...
<html lang="en">
  <head>
    ...
    <script>
		...
		function refreshTable1(){
			$('.tile-body').load('getusageTable.php', function(){
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Usage Information</h1>
          <p>Table to display usage information effectively</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Usage</li>
          <li class="breadcrumb-item active"><a href="#">Usage Info</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
